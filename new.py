...
if choice =="1":
    ...
    webbrowser.open('https://www.youtube.com/watch?v=K-Ina_WW4Yc')
elif choice =="4":
    webbrowser.open('https://youtu.be/XeXz8fIZDCE?t=54')
elif choice =="5":
    webbrowser.open('https://www.youtube.com/watch?v=4C-gxOE0j7s')
elif choice =="6":
    webbrowser.open('https://youtu.be/JOilkvadChg?t=37')
elif choice =="7":
    webbrowser.open('https://www.youtube.com/watch?v=XOTGz-1vizY')
